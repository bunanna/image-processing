...
data = data_stitching.get_data(start_year, start_month, start_day, all_ixps, end_day, end_month, end_year)
...
pickle.dump(stitched_dict, open(file_string + 'rio_de_janeiro' + ".pkl", "wb"))
