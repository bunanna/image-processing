...
def plot_data(filename, ixp, scaled_y_vals, scaled_x, start_date_time, start_date, main_color):
    ...
    if 'day' in filename:
        ...
        scaled_x_vals = map_x_values_month(scaled_y_vals, scaled_x, start_date_time, ixp_type)
        dict_string = 'month'
        ...
        if '5year' in filename and 'Frankfurt' in ixp:
            ...
            file_string = '5years'
            scaled_x_vals = map_x_values_year(scaled_y_vals, scaled_x, start_date_time, True, ixp, dict_string)
