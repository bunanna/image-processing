...
while current_date <= end_date:
    directory_name = str(current_date) + ' Data Sets'
    
    if not os.path.isdir(directory_name):
        os.makedirs(directory_name)
        
    zip_file_name = str(current_date) + " Archive.zip"
    ...
    for selected_ixp in ixps_to_use:
        ...
        data = data_stitching.get_data_no_loop(selected_ixp, current_date.year, current_date.month, current_date.day)
        ...
        for data_type in keys_to_use:
            file_string = str(current_date) + '_' + selected_ixp + '_' + data_type
    ...
    '''
    if os.path.isdir(str(current_date)):
        print('Now deleting extracted folder.')
        shutil.rmtree(os.path.join(current_directory, str(current_date)))
