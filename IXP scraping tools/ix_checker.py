# -*- coding: utf-8 -*-
"""
Created on Sun Nov  1 19:32:34 2020
...
ixp_source = json.load(open("ix_v2.json",'r', encoding='utf-8'))
all_dict = {}
whitelist = [
        'angonix',
        'AMS-IX',
...
for ixp_dict in ixp_source['data']:
    if ixp_dict['url_stats'] != '' and ixp_dict['name'] not in whitelist:
        all_dict[ixp_dict['name']] = {}
        all_dict[ixp_dict['name']]['stats'] = ixp_dict['url_stats']
        all_dict[ixp_dict['name']]['id'] = ixp_dict['id']
