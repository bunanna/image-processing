...
for ixp in ixps_to_use:
    ...
    for plot_type in type_to_use:
        ...
        new_ixp_name = ixp.replace(' ', '_').replace('é', 'e').replace('á', 'a').replace('í', 'i').replace('ç', 'c').replace('ó', 'o').replace('ã', 'a')
        csv_filename =  new_ixp_name + '_' + 'collated' + '_' + plot_type + '.csv'
        ...
        if not os.path.isfile(csv_filename):
            ...
            while found_start == False and found_no_start == False:
                ...
                start_directory_name = str(start_date) + '_data_sets'
                ...
                if not os.path.isdir(complete_directory):
                    ...
                    file_to_find = file_string = str(start_date) + '_' + ixp.replace(' ', '_') + '_' + plot_type + '.csv'
            ...
            while found_end == False and found_no_end == False:
                ...
                end_directory_name = str(end_date) + '_data_sets'
                ...
                if not os.path.isdir(complete_directory):
                    ...
                    os.chdir(complete_directory)
                    file_to_find = file_string = str(end_date) + '_' + ixp.replace(' ', '_') + '_' + plot_type + '.csv'
            ...
            collated_directory = os.path.join(current_directory, 'collated_data_sets_' + str(string_end_date))
