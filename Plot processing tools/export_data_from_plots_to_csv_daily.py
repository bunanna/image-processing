...
directory_name = str(datetime.date(current_year, current_month, current_day)) + '_data_sets'

if not os.path.isdir(directory_name):
    os.makedirs(directory_name)
    
zip_file_name = str(datetime.date(current_year, current_month, current_day)) + "_archive.zip"
...
for selected_ixp in ixps:
    ...
    data = plot_data_to_dict.get_data_no_loop(selected_ixp, current_year, current_month, current_day)
    ...
    for data_type in keys:
        file_string = str(datetime.date(current_year, current_month, current_day)) + '_' + selected_ixp.replace(' ', '_') + '_' + data_type
